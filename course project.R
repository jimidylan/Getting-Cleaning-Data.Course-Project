# This R script gets and cleans human activity data, comprised
# of recordings of subjects performing daily activities while carrying a
...
extract.mean.and.std = function(df) {
  ...
  # Find the mean and std columns and rounding to 4 significant digits
